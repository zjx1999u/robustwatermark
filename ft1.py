...
from trainer import test, train, test_logit
...
wmloader = getwmloader(args.wm_path, 1, args.wm_lbl)
wmloader2 = getwmloader2(args.wm_path, 1, args.wm_lbl)  #not shuffle
...
test(net, criterion, logfile, wmloader2, device)
#print("Original WM Logit:")
#test_logit(net, logfile, wmloader2, device)
...
#print("reinitialize WM Logit:")
#test_logit(net, logfile, wmloader, device)
