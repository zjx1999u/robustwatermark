...
from trainer import test, train,train_L2,train_snnl,testSR
...
for epoch in range(start_epoch, start_epoch + args.max_epochs):
    ...
    train_snnl(epoch, net, criterion, optimizer, logfile, trainloader, device, temper,snnl_weight, wmloader, tune_all=True)
